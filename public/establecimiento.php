...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                	<h4 class="col-10 card-title">ESTABLECIMIENTOS</h4>
								</div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tableLoadDetalle" class="table v-middle" style="width: 100%;">
                                        <thead id="tableCodigoDetalle" class="">
                                            <tr class="bg-light">
                                                <th class="border-top-0">C&Oacute;DIGO</th>
                                                <th class="border-top-0">CATEGOR&Iacute;A</th>
                                                <th class="border-top-0">CANTIDAD</th>
                                                <th class="border-top-0">PESO PROMEDIO</th>
                                                <th class="border-top-0">PESO TOTAL</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                	<h4 class="col-10 card-title">PROPIETARIOS</h4>
                                    <h4 class="col-2 card-title" style="text-align: right;">
                                        <a class="btn btn-info" style="background-color:#005ea6; border-color:#005ea6;"  href="../public/dominiosub_crud.php?dominio=<?php echo $valueDominio; ?>&mode=C&dominio1=0&dominio2=0" role="button" title="Agregar"><i class="ti-plus"></i></a>
                                	</h4>
								</div>
                                <div class="table-responsive">
                                    <table id="tableLoadPropietario" class="table v-middle" style="width: 100%;">
                                        <thead id="tableCodigoPropietario" class="">
                                            <tr class="bg-light">
                                                <th class="border-top-0">C&Oacute;DIGO</th>
                ...
                <!-- Modal Procesar -->
                <div id="modalbuild" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="vcenter" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" id="modalsection">
                    </div>
                </div>
                <!-- Modal Procesar -->
                <!-- ============================================================== -->
